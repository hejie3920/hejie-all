...
export default {
  ...
  data() {
    return {
      json,
      fundStr:
        "001630,004854,114854,002974,161726,007301,001618,501006,004857,008282,160517,001500,009571,002979,000216,006487,163406,005064,320007,005918,001549,008591,001714,001552,161005,006928,003096,005827,004746,001027,001632,161725,260108,501058,000248,160634,165520,001156,400015,163115,000596",
      fundList: []
    }
  },
  created() {
