...
- [杂项](#%E6%9D%82%E9%A1%B9)
  ...
  - [eslint](#eslint)
  - [骚技巧](#%E9%AA%9A%E6%8A%80%E5%B7%A7)
...
debounce(func, wait = 200) {
 ...
 return function () {
   let _this = this
   <!-- 如果不用_this的话，函数的this会指向window，因为最终的运行的是window.setTimeout() -->
...
方案二：使用 inobounce.js
在 html 主页面 的 header 标签中引入 inbounce.js，即 <script src="./inbounce.js"></script>。当引入此文件之后，iOS 端整个页面都无法滑动或滚动，若想滚动的元素能够实现滚动效果，则需要对滚动区域设置固定的高度，即 height、max-height，同时也要设置 overflow: auto，实现页面滑动。为防止 iOS 端页面滚动发生卡顿现象，需要对滚动区域设置 -webkit-overflow-scrolling: touch 属性
